...
- Extension, not implemented: a centralized fine-tuning row (same total epochs, no FL split) would isolate "cost of federation" directly — skipped for time and GPU compute
